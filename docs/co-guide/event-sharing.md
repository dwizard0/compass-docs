...
![Event page with the Sharing panel in the sidebar](../img/Event Share - Share step 1.png)
...
![Event sharing page with region and fleet options](../img/Event Share - Share step 2.png)
...
![Sharing page showing an active share](../img/Event Share - Share step 3.png)
...
![Expected attendance broken down by chapter](../img/Event Share - RSVP view.png)
...
![Shared events list showing a chapter-hosted event](../img/Event Share - Shared List.png)
...
![Shared event shown on the ship calendar](../img/Event Share - Cal Shared a.png)

![Shared event details from the calendar](../img/Event Share - Cal Shared b.png)
