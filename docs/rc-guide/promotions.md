...
![Promotion Eligibility Report from CO view — showing two promotions submitted and pending RC review](../img/Promotion Elig Report (CO) - Workflow 2c.png)
...
![Regional Promotions page — O-6 Pending Approval and O-7+ Pending Recommendation queues](../img/Promotion Elig Report (CO) - Workflow 2d.png)
...
![RC review panel — O-6 submission showing member details and CO recommendation](../img/Promotion Elig Report (CO) - Workflow 2e.png)
...
![RC review panel — scrolled to bottom showing Approve and Reject buttons](../img/Promotion Elig Report (CO) - Workflow 2f.png)
...
![RC review panel — O-7+ submission showing CO recommendation and nomination narrative](../img/Promotion Elig Report (CO) - Workflow 3a.png)

Review the full submission including all nomination form answers. Edit any answers inline if needed.

![RC review panel — O-7+ scrolled to bottom showing Recommend to Fleet, Nomination Form, and Reject](../img/Promotion Elig Report (CO) - Workflow 3b.png)
...
![Regional Promotions page — showing Awaiting Fleet Decision status with Record Fleet Decision and Nomination Form buttons](../img/Promotion Elig Report (CO) - Workflow 3d.png)
...
![Regional Promotions page — final state after fleet decision recorded, showing Approved status](../img/Promotion Elig Report (CO) - Workflow 3f.png)
